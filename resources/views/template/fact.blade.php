    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                <div class="video">
                    <button type="button" class="btn btn-play" data-bs-toggle="modal" data-src="{{ asset('template') }}/https://www.youtube.com/embed/DWRcNpR6Kdc" data-bs-target="#videoModal">
                        <span></span>
                    </button>
                </div>
            </div>
        ...
        <div class="modal-content rounded-0">
            ...
            <div class="modal-body">
                ...
                <div class="ratio ratio-16x9">
                    <iframe class="embed-responsive-item" src="{{ asset('template') }}/" id="video" allowfullscreen allowscriptaccess="always"
